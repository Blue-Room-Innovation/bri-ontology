...
|   `-- invalid-product-sample.ttl # Ejemplo TTL inválido (para SHACL)
|-- docs/
...
|   |-- build.md                   # Artefactos de build (merged & reasoned)
...
|   `-- interpretar-resultados.md  # Cómo interpretar los informes
|-- scripts/
