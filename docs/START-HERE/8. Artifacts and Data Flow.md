...
📌 **SHACL is the key bridge** between:
...
- `ontology/<ontology_version>/index.md` and `shapes/<shapes_version>/index.md` avoid “directory not found” errors when opening folder URLs.
...
- **Codelists** → independent release
- **Ontologies + Shapes + Examples** → synchronized release
