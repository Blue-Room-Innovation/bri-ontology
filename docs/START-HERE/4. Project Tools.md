...
>
> - `docs/wiki/index.md`: Summary table
> - `docs/wiki/<ontology>/README.md`: Class and property documentation
> - `docs/wiki/<ontology>/SHAPES.md`: SHACL constraint documentation
> - `docs/wiki/<ontology>/diagram.svg`: Visual class diagrams (Mermaid)
>
> Configuration based on [[3. Configuration#11) Wiki (`wiki`)|config.yaml]]
...
>
> Configuration based on [[3. Configuration#8) Generation (`generation`)|config.yaml]]
