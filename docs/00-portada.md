...
3. `03-instalacion.md` Preparar entorno (Docker) en 2 minutos.
4. `04-validacion-express.md` Ver algo funcionando (validar ejemplo de waste passport).
5. `05-modelo-datos.md` Clases y relaciones principales (DigitalWastePassport ↔ WastePassport ↔ Waste).
...
13. `13-shapes-referencia.md` Reglas SHACL clave (pasaporte, residuos, MARPOL).
14. `14-iri-warnings.md` Por qué aparecen y cómo gestionarlos.
15. `15-roadmap.md` Futuras líneas (renombrar artefactos, ampliar residuo/métricas).
16. `16-vocabularios-imports.md` Estrategia stubs vs imports y codelists.
17. `17-taxonomias-plan.md` Taxonomías SKOS faltantes.
18. `18-validacion-ejemplos.md` Casos válidos / inválidos y comandos.
19. `19-contribuir.md` Workflow de contribución.
